...
# Estructura de Datos
# Unidad 3
# Nodo Numeros.py    Listas Ligadas
...
def main(): 
    lista = None 
    lista = agregar_al_final(lista, 5) 
    lista = agregar_al_final(lista, 8) 
    lista = agregar_al_inicio(lista, 10) 
    lista = agregar_al_final(lista, 20)
    lista = agregar_al_final(lista, 36) 
    lista = agregar_al_final(lista, 1) 
    lista = agregar_al_inicio(lista, 9) 
    lista = agregar_al_final(lista, 6)
    lista = agregar_al_inicio(lista, 12) 
    lista = agregar_al_final(lista, 14)

    print("Antes de eliminar: ") 
    imprimir_lista(lista)

    lista = eliminar(lista, 36) 

    print("\nDespués de eliminar: ") 
    imprimir_lista(lista)  

    print(existe(lista, 36))  
    print(existe(lista, 6))
    
    print(obtener_cabeza(lista).dato)  # type: ignore 
    print(obtener_cola(lista).dato) # type: ignore 
